...
conc_ld <- function(staName,sdate,edate,chem,wy){
  ...
  # API endpoint
  url <- paste0('https://api.sfwmd.gov/v1/insights-data/chem/report/data?reportType=timeseries&format=csv&startDate=',sdate.f,'&endDate=',edate.f,'&station=',staName,'&parameters=',chem)
